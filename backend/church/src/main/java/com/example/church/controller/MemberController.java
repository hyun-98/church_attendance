...
public class MemberController {
    ...
    public ResponseEntity<Member> createMember(
            ...
            @RequestParam(required = false) String ageGroup,  // 추가
        ...
        try {
            Member saved = memberService.createMemberWithFile(
                    name, birthDate, phone, ageGroup, hasAttended, registeredAt, photo, uploadDir
            );
    ...
    public ResponseEntity<Member> updateMember(
            ...
            @RequestParam(value = "ageGroup", required = false) String ageGroup,  // 추가
        ...
        try {
            Member updated = memberService.updateMemberWithFile(
                    id, name, birthDate, phone, ageGroup, hasAttended, registeredAt, photo, uploadDir
            );
